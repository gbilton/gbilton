# Hi, I'm Guilherme Bilton 👋

**Full-Stack Engineer** · Python & React · ~5 years shipping production web apps end to end.

I build typed Python backends (FastAPI, Django), React/Next.js frontends, and the AWS infrastructure underneath them — and I lean heavily on AI-assisted engineering and LLM-agent infrastructure to ship faster without dropping code quality.

📍 São Paulo, Brazil · working US hours · **open to remote roles (US/EU)** · fluent English

---

### 🛠️ Tech

**Backend** Python · FastAPI · Django · REST APIs · Celery/RQ · PostgreSQL · Redis · PyTest
**Frontend** React · Next.js · TypeScript · TanStack Query/Router · Tailwind · shadcn/ui
**Infra & AI** AWS · Docker · NGINX · CI/CD · LLM API integration · AI-agent deployment · agentic workflows
...
[LinkedIn](https://linkedin.com/in/gbilton) · guilhermebilton@gmail.com
